...
public class ProcessFunctionTest {
	...
	@Test
	public void testKeyInProcessCall() throws Exception {
		...
		pages.keyBy(new MyKeySelector()).process(new MyProcessFunction()).print();
	...
	private static class MyProcessFunction extends ProcessFunction<Tuple2<String, Float>, Tuple2<String, Float>> {
		...
		public void onTimer(long timestamp,
		        ProcessFunction<Tuple2<String, Float>, Tuple2<String, Float>>.OnTimerContext ctx,
